...
/* tagging */
static const char *tags[] = {"", "", "" ,"", "5", "󰙯", "7", "8", "9"};
...
static const Key keys[] = {
  ...
  {0, f9key,                    spawn, SHCMD("betterlockscreen -l blur")}, //to lock screen
  {0, printsc,                  spawn, SHCMD("flameshot gui")}, //to take screenshot
  {MODKEY | ShiftMask, XK_p, spawn, SHCMD("~/.local/bin/power_menu")},
  {MODKEY | ShiftMask, XK_x, spawn, SHCMD("~/.local/bin/killallinstances")},
  {MODKEY | ShiftMask, XK_w, spawn, SHCMD("~/.local/bin/rofiwificonnection")},
  {ALTKEY, 0xff52, spawn, SHCMD("~/.local/bin/bright_notif up")},
  {ALTKEY, 0xff54, spawn, SHCMD("~/.local/bin/bright_notif down")},
  ...
  {ALTKEY, XK_z,   spawn, SHCMD("st ranger ~/school")},
